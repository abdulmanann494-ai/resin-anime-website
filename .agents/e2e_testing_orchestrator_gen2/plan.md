...
- **F7: Performance & Quality Metrics**
  ...
  - Performance endpoint reports response times.
  - Cache flush clears memory/db cache segments.
- **F8: Interactive Workflows & Infrastructure**
  - Keyboard alternative focus checks.
  - Modal focus trap behaves correctly.
  - Simplified English copy check for UI text files.
